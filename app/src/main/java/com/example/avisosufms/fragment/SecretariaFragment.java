...
public class SecretariaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_secretaria, container, false);
    ...
    private void configuracoesIniciais(View view) {
        recyclerView = view.findViewById(R.id.recyclerSecretaria);
        listaPostagem = new ArrayList<>();


        //postagemAdapter = new PostagemAdapter();
        postagensReference = ConfiguracaoFirebase.getFirebaseDatabaseReference().child("postagem-secretaria");
    }
